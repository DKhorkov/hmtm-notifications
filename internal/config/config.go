...
func New() Config {
	return Config{
		...
		Email: EmailConfig{
			...
			VerifyEmailURL:    loadenv.GetEnv("EMAIL_VERIFY_URL", "http://localhost:8090/verify-email"),
			ForgetPasswordURL: loadenv.GetEnv("FORGET_PASSWORD_URL", "http://localhost:8090/forget-password"),
		},
	}
}
