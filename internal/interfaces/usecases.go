...
type UseCases interface {
	...
	SendForgetPasswordEmailCommunication(
		ctx context.Context,
		userID uint64,
		newPassword string,
	) (emailID uint64, err error)
	SendUpdateTicketEmailCommunication(
		ctx context.Context,
		ticketID uint64,
	) (emailIDs []uint64, err error)
	SendDeleteTicketEmailCommunication(
		ctx context.Context,
