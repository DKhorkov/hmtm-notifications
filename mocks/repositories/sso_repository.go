...
//
//	mockgen -source=repositories.go -destination=../../mocks/repositories/sso_repository.go -exclude_interfaces=ToysRepository,EmailsRepository,TicketsRepository -package=mockrepositories
//
